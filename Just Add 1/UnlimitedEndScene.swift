...
class UnlimitedEndScene: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        EndGameHighScore.text = String("Highscore: " + String(savedhighscoreUnlimited))
        ...
        Analytic.GameEnd(gamemode: 2, score: endgamescore)
    ...
    @IBAction func TwtterShare(_ sender: Any) {
        let endgamescore = UserDefaults.standard.integer(forKey: "lastscore")
